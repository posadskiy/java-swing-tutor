...
# Build commands
DEB_CMD="jpackage --input target --name 'Java Swing Tutor' --main-jar $JAR_NAME --main-class com.posadskiy.javaswingtutor.Start --type deb --dest target/jpackage --app-version $APP_VERSION --vendor Posadskiy --java-options '-Dfile.encoding=UTF-8' --linux-menu-group Education --linux-shortcut --linux-package-name javaswingtutor"
APP_IMAGE_CMD="jpackage --input target --name 'Java Swing Tutor' --main-jar $JAR_NAME --main-class com.posadskiy.javaswingtutor.Start --type app-image --dest target/jpackage --app-version $APP_VERSION --vendor Posadskiy --java-options '-Dfile.encoding=UTF-8'"
