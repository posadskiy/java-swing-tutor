-- Flyway migration V3: Insert documentation records with IDs 1-465
-- Documentation table now only contains id column (text is in documentation_translation table)
